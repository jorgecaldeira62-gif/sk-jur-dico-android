...
export default function Mapa() {
  ...
  const pages = [
    ...
    { route: "/codigo", name: "Assistente de Código", color: "#0e7490", desc: "IA para código — usa APENAS sua chave, 100% privado" },
  ...
  const aiFlow = [
    ...
    { n: "2", t: "Verifica chave", d: "Chave própria → usa ela. Sem chave → tenta demo gratuita. Tudo falhou → erro." },
